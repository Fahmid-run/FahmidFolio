...
const skills = [
  ...
  'Tailwind CSS', 'Postman', 'RAG Systems','Better Auth'
]
            ...
            >
              ...
              >
                ...
                <img
                  ...
                  alt="Fahmid"
                  className="w-80 mx-auto mt-2 object-cover"
                />
              </div>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                from Bangladesh, passionate about building elegant and
                performant digital experiences. I love transforming complex
                problems into clean, intuitive solutions.
              </p>
              <p
                className="text-base md:text-lg leading-relaxed"
                style={{
              ...
              >
                Currently exploring system design, AI integration, and scalable
                web architecture. I believe great software should be both
                technically sound and visually exceptional.
              </p>
            </div>
